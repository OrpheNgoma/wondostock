                        ...
                        <div class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-6 border-2 border-dashed border-gray-300">
                            <div class="flex items-center space-x-6">
                                ...
                                <div class="flex-shrink-0">
                                    @if ($logo)
                                        <img src="{{ $logo->temporaryUrl() }}" class="h-20 w-20 rounded-xl object-cover border-2 border-purple-200 shadow-lg" alt="Aperçu du logo">
                                    @elseif ($company->hasMedia('logo'))
                                        <img src="{{ $company->getFirstMediaUrl('logo') }}" class="h-20 w-20 rounded-xl object-cover border-2 border-purple-200 shadow-lg" alt="Logo actuel">
                                    @else
                                ...
                                <div class="flex-1">
                                    ...
                                    <div wire:loading wire:target="logo" class="mt-2 text-sm text-purple-600 flex items-center space-x-2">
