    ...
    @if(!empty($unauthorized))
        <div class="flex items-center justify-center min-h-screen">
            <div class="text-center py-16">
                ...
                <h3 class="text-xl font-semibold text-gray-700 mb-2">Activité Magasin</h3>
                <p class="text-gray-500 max-w-md mx-auto">Vous n'avez pas accès à cette section. Contactez votre administrateur pour demander les permissions appropriées.</p>
            </div>
        </div>
    @else
