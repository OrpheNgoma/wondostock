...
<head>
    ...
    <!-- ApexCharts - Modern charting library compatible avec Livewire 3 -->
    <script src="https://cdn.jsdelivr.net/npm/apexcharts@3.45.2/dist/apexcharts.min.js"></script>
    <!-- ApexCharts Service pour WondoStock -->
    @vite('resources/js/charts/ApexChartsService.js')
                    ...
                    <ul role="list" class="flex flex-1 flex-col gap-y-7">
                        ...
                        <li>
                            ...
                            <ul role="list" class="space-y-1">
                                ...
                                @can('view_stock_purchases')
                                <li>
                                    <a href="{{ route('stock-purchases.index') }}"
                                       class="group flex gap-x-3 rounded-lg p-3 text-sm font-medium leading-6 {{ request()->routeIs('stock-purchases.*') ? 'bg-indigo-50 text-indigo-700 border-r-2 border-indigo-600' : 'text-gray-700 hover:text-indigo-700 hover:bg-gray-50' }} transition-all duration-200">
                                        <svg class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        ...
                        <li>
                            ...
                            <ul role="list" class="space-y-1">
                                ...
                                <li>
                                    <a href="{{ route('stock-purchases.index') }}"
                                       @click="sidebarOpen = false"
                                       class="group flex gap-x-3 rounded-lg p-3 text-sm font-medium leading-6 {{ request()->routeIs('stock-purchases.*') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-700 hover:text-indigo-700 hover:bg-gray-50' }} transition-all duration-200">
                                        <svg class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 10.5V6a3.75 3.75 0 1 0-7.5 0v4.5m11.356-1.993 1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 0 1-1.12-1.243l1.264-12A1.125 1.125 0 0 1 5.513 7.5h12.974c.576 0 1.059.435 1.119 1.007Z"/>
                                        </svg>
                                        Achat de stock
